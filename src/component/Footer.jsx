...
const Footer = () => {
    return (
        <div className="container-fluid">
            <div className="row py-5" style={{ backgroundColor: "var(--tertiary-color)" }}>
                <div className="col-lg-3">
                    ...
                    <div className="container-fluid row d-flex m-0 p-0 ">
                        <div className="col-2 h-25px">
                            <div className="rounded-circle hbr-1 border border-light position-relative h-100 w-100 p-3"><i className="fa-solid fa-phone fa-lg position-absolute top-50 start-50 translate-middle" style={{ color: "white" }}></i></div>
                        </div>
                        <div className="col-2 h-25px">
                            <div className="rounded-circle hbr-1 border border-light position-relative h-100 w-100 p-3"><i className="fa-solid fa-phone fa-lg position-absolute top-50 start-50 translate-middle" style={{ color: "white" }}></i></div>
                        </div>
            ...
            <div className="fs-5" style={{ backgroundColor: "var(--primary-color)" }}>
